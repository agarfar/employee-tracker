...
// helper function from role.js
const { getRoles } = require('./role');

// returns current list of employees
...
const addEmployee = async () => {
    ...
    // if employee does not have a manager, return null
    if (managerName === 'N/A') {
        ...
        // if manager is specified, insert the manager id 
    } else {
